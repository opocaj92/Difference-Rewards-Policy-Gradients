...
import copy
import os
from envs.gridworld.multi_rover import MultiRover
...
env = MultiRover(n_agents = n_agents)

savepath = "maastar_multi_rover_n" + str(n_agents)
